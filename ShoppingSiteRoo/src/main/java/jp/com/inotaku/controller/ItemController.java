...
public class ItemController {
	...
	public String findItemsByItemNameLike(
		...
		if (page != null || size != null) {
			...
			uiModel.addAttribute(
					"items",
					Item.findItemsByItemNameLike(itemName, sortFieldName,
							sortOrder).setFirstResult(firstResult)
							.setMaxResults(sizeNo).getResultList());
			float nrOfPages = (float) Item
					.countFindItemsByItemNameLike(itemName) / sizeNo;
			uiModel.addAttribute(
					"maxPages",
	...
	public String create(@Valid Item item, BindingResult bindingResult,
		...
		return "redirect:/items/"
				+ encodeUrlPathSegment(item.getId().toString(),
						httpServletRequest);
	}
	...
	void populateEditForm(Model uiModel, Item item) {
		...
		uiModel.addAttribute("saledetailses",
				SaleDetails.findAllSaleDetailses());
	}
