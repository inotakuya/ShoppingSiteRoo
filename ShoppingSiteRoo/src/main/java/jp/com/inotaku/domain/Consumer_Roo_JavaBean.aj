...
privileged aspect Consumer_Roo_JavaBean {
    ...
    public String Consumer.getAddress() {
        return this.address;
    }
    
    public void Consumer.setAddress(String address) {
    ...
    public Set<Sale> Consumer.getSale() {
        return this.sale;
    }
    
    public void Consumer.setSale(Set<Sale> sale) {
        this.sale = sale;
    }
