...
privileged aspect SaleDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    SaleService SaleDataOnDemand.saleService;
    
    @Autowired
    SaleRepository SaleDataOnDemand.saleRepository;
    
    public Sale SaleDataOnDemand.getNewTransientSale(int index) {
        Sale obj = new Sale();
        setConsumer(obj, index);
        setSaleId(obj, index);
    ...
    public void SaleDataOnDemand.setConsumer(Sale obj, int index) {
        Consumer consumer = consumerDataOnDemand.getRandomConsumer();
        obj.setConsumer(consumer);
    }
    ...
    public void SaleDataOnDemand.init() {
        int from = 0;
        int to = 10;
        data = saleService.findSaleEntries(from, to);
        if (data == null) {
