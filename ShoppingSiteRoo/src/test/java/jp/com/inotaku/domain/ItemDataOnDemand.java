...
public class ItemDataOnDemand {
	...
	public void setDescription(Item obj, int index) {
        String description = "description_" + index;
        obj.setDescription(description);
    }

	public void setItemId(Item obj, int index) {
        Long itemId = new Integer(index).longValue();
        obj.setItemId(itemId);
    }

	public void setItemName(Item obj, int index) {
        String itemName = "itemName_" + index;
        obj.setItemName(itemName);
    }

	public void setPictureUrl(Item obj, int index) {
