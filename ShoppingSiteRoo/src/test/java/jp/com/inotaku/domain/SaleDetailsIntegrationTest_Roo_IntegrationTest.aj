...
import jp.com.inotaku.domain.SaleDetailsIntegrationTest;
...
privileged aspect SaleDetailsIntegrationTest_Roo_IntegrationTest {
    
    declare @type: SaleDetailsIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: SaleDetailsIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: SaleDetailsIntegrationTest: @Transactional;
    
    @Autowired
    SaleDetailsDataOnDemand SaleDetailsIntegrationTest.dod;
    
    @Test
    public void SaleDetailsIntegrationTest.testCountSaleDetailses() {
    ...
    @Test
    public void SaleDetailsIntegrationTest.testFindSaleDetails() {
    ...
    @Test
    public void SaleDetailsIntegrationTest.testFindAllSaleDetailses() {
        Assert.assertNotNull("Data on demand for 'SaleDetails' failed to initialize correctly", dod.getRandomSaleDetails());
        long count = SaleDetails.countSaleDetailses();
    ...
    @Test
    public void SaleDetailsIntegrationTest.testFindSaleDetailsEntries() {
        Assert.assertNotNull("Data on demand for 'SaleDetails' failed to initialize correctly", dod.getRandomSaleDetails());
        long count = SaleDetails.countSaleDetailses();
    ...
    @Test
    public void SaleDetailsIntegrationTest.testFlush() {
        SaleDetails obj = dod.getRandomSaleDetails();
        Assert.assertNotNull("Data on demand for 'SaleDetails' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'SaleDetails' failed to provide an identifier", id);
    ...
    @Test
    public void SaleDetailsIntegrationTest.testMergeUpdate() {
        SaleDetails obj = dod.getRandomSaleDetails();
        Assert.assertNotNull("Data on demand for 'SaleDetails' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'SaleDetails' failed to provide an identifier", id);
    ...
    @Test
    public void SaleDetailsIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'SaleDetails' failed to initialize correctly", dod.getRandomSaleDetails());
    ...
    @Test
    public void SaleDetailsIntegrationTest.testRemove() {
        SaleDetails obj = dod.getRandomSaleDetails();
        Assert.assertNotNull("Data on demand for 'SaleDetails' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'SaleDetails' failed to provide an identifier", id);
